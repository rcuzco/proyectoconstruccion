...
@Component({
  selector: 'app-climatizacion-calefaccion',
  templateUrl: './climatizacion-calefaccion.component.html',
  styleUrls: ['./climatizacion-calefaccion.component.scss']
})
export class ClimatizacionCalefaccionComponent implements OnInit{
