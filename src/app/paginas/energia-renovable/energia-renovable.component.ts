...
@Component({
  selector: 'app-energia-renovable',
  templateUrl: './energia-renovable.component.html',
  styleUrls: ['./energia-renovable.component.scss']
})
export class EnergiaRenovableComponent implements OnInit {
