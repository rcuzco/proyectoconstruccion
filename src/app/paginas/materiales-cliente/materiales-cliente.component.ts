...
export class MaterialesClienteComponent implements OnInit
{
  ...
  constructor(private materialesService: MaterialesClienteService, private router: Router, private presupuestoService: PresupuestosService, public globalDataService: GlobalDataService, private clienteService: ClientesService) { }
