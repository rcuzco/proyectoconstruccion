...
export class MaterialesClienteComponent implements OnInit
{
  ...
  constructor(private materialesService: MaterialesClienteService, private facturasService: FacturasService, private router: Router, private presupuestoService: PresupuestosService, public globalDataService: GlobalDataService, private clienteService: ClientesService) { }
