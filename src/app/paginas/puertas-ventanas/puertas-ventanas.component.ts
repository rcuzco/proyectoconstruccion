...
@Component({
  selector: 'app-puertas-ventanas',
  templateUrl: './puertas-ventanas.component.html',
  styleUrls: ['./puertas-ventanas.component.scss']
})
export class PuertasVentanasComponent implements OnInit {
